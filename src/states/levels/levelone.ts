...
export default class LevelOne extends Phaser.State {
  ...
  public create(): void {
    ...
    this.waves[11] = [
      new Enemy(this.game, randomYPos(this.game.height), new SlowMoveStrategy(true), new TrackingAttackStrategy()),
      new Enemy(this.game, randomYPos(this.game.height), new SlowMoveStrategy(false), new TrackingAttackStrategy()),
      new Enemy(this.game, randomYPos(this.game.height), new SlowMoveStrategy(true), new TrackingAttackStrategy()),
      new Enemy(this.game, randomYPos(this.game.height), new SlowMoveStrategy(false), new TrackingAttackStrategy()),
      new Enemy(this.game, randomYPos(this.game.height), new SlowMoveStrategy(true), new TrackingAttackStrategy()),
      new Enemy(this.game, randomYPos(this.game.height), new SlowMoveStrategy(false), new TrackingAttackStrategy()),
